Shader "Avalin/T-Shirt-Shader-Animated-Logo"
{	
	/*
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
			...
			/*
			* This logo will disappear and reappear with following sine curve, SinTime.y
			*/

            o.Albedo = lerp(LogoColor.rgb * SplashColor.rgb + MainColor * (1 - SplashColor.rgb), MainColor, _SinTime.w);
